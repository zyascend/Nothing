    ...
    public static class MatchBean {
        ...
        public static class MatchCommentsBean {
            ...
            public static class ReplyUserBean {
                ...
                private UserBean.CoverBean cover;
                private String description;
                private int finishType;
                private int gender;
                private UserBean.HeadBean head;
                private String id;
                private String name;
                private int praise;
                private String userTitleDesc;

                public UserBean.CoverBean getCover() {
                    return cover;
                }

                public void setCover(UserBean.CoverBean cover) {
                    this.cover = cover;
                }
                ...
                public UserBean.HeadBean getHead() {
                    return head;
                }

                public void setHead(UserBean.HeadBean head) {
                    this.head = head;
                }
